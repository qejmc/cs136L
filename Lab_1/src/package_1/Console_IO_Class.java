 ...
 */
/*
Rev: Update 9 June 2002, added isDigit, fixed promptForDouble input bug
...
public class Console_IO_Class
    ...
    */
    ...
    /*
    name: charToInt
    process: converts character value to equivalent integer value
   ...
   */
   ...
   /*
   name: intToChar
   process: converts integer value to character value
   ...
   */
   ...
   /*
   name: isDigit
   process: accepts character, reports if it is digit
